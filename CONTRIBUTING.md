# Contributing to New Relic OpenTelemetry Java Exporters
Thanks for your interest in contributing to the New Relic OpenTelemetry Java Exporters! We look forward to engaging with you.
...
We'd love to get your contributions to improve New Relic OpenTelemetry Java Exporters! Keep in mind when you submit your pull request, you'll need to sign the CLA via the click-through using CLA-Assistant. You only have to sign the CLA one time per project.
...
* Any modifications made to the New Relic OpenTelemetry Java Exporters
...
If you can build the New Relic OpenTelemetry Java Exporters, you can contribute to them!
...
## Testing Guidelines
The New Relic OpenTelemetry Java Exporters include the following tests which must pass:
